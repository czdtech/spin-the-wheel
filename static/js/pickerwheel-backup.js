        ...
        try {
            ...
            const basePath = isLocal ? './static/music/' : '/static/music/';
            
            spinSound = new Audio(basePath + 'spin.mp3');
            spinSound.loop = true;
            winSound = new Audio(basePath + 'win.mp3');
            clickSound = new Audio(basePath + 'whoosh.mp3');
        } catch (e) {
